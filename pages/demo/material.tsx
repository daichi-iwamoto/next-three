...
const ThreeDemoPage = () => {
  return (
    <main className={styles.main}>
      <header>
        <Link href="/">&larr; 戻る</Link>
        <h1 className={styles.title}>Material Demo Page</h1>
        <p>
          描画するオブジェクトの材質を指定できる<code>Material</code>
          のデモページです
          <br />
          ここで紹介している以外にも沢山の材質が指定できるので
          <br />
          そちらはThree.jsの
          <a href="https://threejs.org/docs/index.html#api/en/materials/MeshNormalMaterial">
            公式ドキュメント
          </a>
          で見てみて下さい
        </p>
