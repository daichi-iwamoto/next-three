  ...
  return (
    <main className={styles.main}>
      <header>
        ...
        <h1 className={styles.title}>Light Demo Page</h1>
        <p>
          描画するオブジェクトを照らす<code>Light</code>のデモページです
          <br />
          ここで紹介している以外にも沢山のライトが指定できるので
          <br />
          そちらはThree.jsの
          <a href="https://threejs.org/docs/index.html#api/en/lights/AmbientLight">
            公式ドキュメント
          </a>
          で見てみて下さい
        </p>
